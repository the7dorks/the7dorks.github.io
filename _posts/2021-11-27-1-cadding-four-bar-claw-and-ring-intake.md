...
<img class="responsive-img" width="500px" src="/assets/pics/building/robot-2/Ringss.png">
...
<img class="responsive-img" width="150px" src="/assets/pics/brainstorming/dr4b.png">
...
<img class="responsive-img" width="300px" src="/assets/pics/brainstorming/Screenshot 2022-02-23 10.59.45 AM.png">
...
<img class="responsive-img" width="500px" src="/assets/pics/building/robot-2/Descore.png">

<br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'>

<img class="responsive-img" width="500px" src="/assets/pics/building/robot-2/HoldingHigh.png">

<br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'>

##### Robot-2.0.0

At the end of the day we managed to make our simple ring conveyor, four bar lift, and claw in one final design.

<img class="responsive-img" width="400px" src="/assets/pics/building/robot-2/FinalCad.png">
