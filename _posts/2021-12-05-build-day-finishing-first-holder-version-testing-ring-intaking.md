...
- Down position:<br><img class="responsive-img" width="500" src="/assets/pics/Photos-001/20211205_180450.jpg">

<br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'>

- Up position:<br><img class="responsive-img" width="500" src="/assets/pics/Photos-001/20211205_175942.jpg">

<br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'>

- Here are sketches we made prior to building the holder:<br><img class="responsive-img" width="400" src="/assets/pics/building/robot-3/TERRIBLEDRAWING.jpg">
...
###### Create
- We also added a gear ratio on the ring intake to make it 400rpm, because 200 and 600 rpm were too slow and too fast respectively.<br><img class="responsive-img" width="500" src="/assets/pics/Photos-001/20211205_180339.jpg">

<br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'><br class='print-only'>

- We also added a black Lexan shroud to try to bounce rings onto the mobile goal post:<br><img class="responsive-img" width="500" src="/assets/pics/Photos-001/20211205_175932.jpg">
